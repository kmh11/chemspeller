...
function animateTable(spelling, line) {
	if (!spelling) {
		document.getElementById("tables").innerHTML = "<h1>Impossible!</h1>"
	} else {
		var delay = 50;
